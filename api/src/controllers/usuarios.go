...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	paremetros := mux.Vars(r)

	usuarioID, erro := strconv.ParseUint(paremetros["usuarioId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
// AtulizarUsuario Atualiza dados do usuario
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel realizar alterações em um perfil"))
	}
...
// DeletarUsuario apaga usuariousuaa
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel voce para de seguir você mesmo"))
		return
	}
...
// BuscarSeguidores permite buscar seguidores
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual não condiz com a senha contida no bando de dados."))
		return
	}
